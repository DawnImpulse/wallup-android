            ...
            viewModelScope.launch {
                ...
                try {
                    ...
                    contents.forEach {
                        ...
                        imageList.add(it) // add to home list
                    }
                    if (contents.size >= LIST_COUNT)
                    ...
                    imageList.removeAt(imageList.size - 1)
                    imageList.add(ObjectReload(RELOAD_MORE_ACTIVITY_DEVICE_IMAGES, F.handleException(e, ERROR_DEVICE_IMAGES_MORE, true)))
                    e.printStackTrace()
                }
                // post list
                liveList.postValue(imageList)
    ...
    private fun fetchImages() {
        viewModelScope.launch {
            ...
            try {
                ...
                errorHandler.postValue(F.handleException(e, ERROR_DEVICE_IMAGES, false))
                e.printStackTrace()
            }
        }
    }
