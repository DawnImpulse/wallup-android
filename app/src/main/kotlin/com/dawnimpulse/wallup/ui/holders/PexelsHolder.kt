 ...
 * @note Updates :
 */
class PexelsHolder(val view: View) : RecyclerView.ViewHolder(view) {
    val imageFrame = view.imageMain
    val image = view.imageMain
    val layout = view.imageL
    val context = view.context

    fun bind(item: PexelsImageObject) {
        ...
        ImageHandler.setImageImgix(image, item.src.original)
    }
}