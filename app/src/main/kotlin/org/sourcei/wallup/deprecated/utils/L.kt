...
object L {
    ...
    fun d(filename: String, message: Any) {
        if (BuildConfig.DEBUG)
            Log.d(org.sourcei.wallup.deprecated.utils.C.WALLUP, "$filename :: $message")
    }
    ...
    fun dO(filename: String, message: Any) {
        if (BuildConfig.DEBUG)
            Log.d(org.sourcei.wallup.deprecated.utils.C.WALLUP, "$filename :: ${Gson().toJson(message)}")
    }
    ...
    fun e(filename: String, message: Any) {
        if (BuildConfig.DEBUG)
            Log.e(org.sourcei.wallup.deprecated.utils.C.WALLUP, "$filename :: $message")
    }
