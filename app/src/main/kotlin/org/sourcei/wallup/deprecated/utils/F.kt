...
object F {
    ...
    fun unsplashUser(username: String): String {
        return "https://unsplash.com/@$username${org.sourcei.wallup.deprecated.utils.C.UTM}"
    }

    // create unsplash image referral link
    fun unsplashImage(id: String): String {
        return "https://unsplash.com/photos/$id${org.sourcei.wallup.deprecated.utils.C.UTM}"
    }
    ...
    fun like(context: Context, view: AppCompatImageView, id: String, toLike: Boolean, color: Boolean = false) {
        var model = org.sourcei.wallup.deprecated.models.UnsplashModel((context as AppCompatActivity).lifecycle)
        ...
        if (color) {
            like!!.setColorFilter(org.sourcei.wallup.deprecated.utils.Colors(context).WHITE, PorterDuff.Mode.SRC_ATOP)
            unlike!!.setColorFilter(org.sourcei.wallup.deprecated.utils.Colors(context).WHITE, PorterDuff.Mode.SRC_ATOP)
        }
    ...
    fun connectivityListener(context: Context) {
        GlobalScope.launch {
            while (true) {
                ...
                org.sourcei.wallup.deprecated.utils.Config.CONNECTED = isConnected

                val obj = JSONObject()
                obj.put(org.sourcei.wallup.deprecated.utils.C.TYPE, org.sourcei.wallup.deprecated.utils.C.NETWORK)
                obj.put(org.sourcei.wallup.deprecated.utils.C.NETWORK, isConnected)
