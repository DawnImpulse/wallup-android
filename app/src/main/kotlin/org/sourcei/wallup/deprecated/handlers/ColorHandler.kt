...
object ColorHandler{
    ...
    fun getNonDarkColor(mPalette: Palette, mContext: Context): Int {
        org.sourcei.wallup.deprecated.handlers.ColorHandler.context = mContext
        ...
        colorNonDark = org.sourcei.wallup.deprecated.handlers.ColorHandler.isColorNonDark(color)
    ...
    fun isColorNonDark(color: Int): Boolean {
        ...
        return org.sourcei.wallup.deprecated.handlers.ColorHandler.getContrastColor(color) == org.sourcei.wallup.deprecated.utils.Colors(org.sourcei.wallup.deprecated.handlers.ColorHandler.context).BLACK
    }
