...
object C {
    ...
    const val NEW_COLLECTION = "newCollection"
    ...
    const val IMAGE_WALLPAPER_QUALITY = "imageWallpaperQuality"
    const val IMAGE_DOWNLOAD_ASK = "imageDownloadAsk"
    const val IMAGE_WALLPAPER_ASK = "imageWallpaperAsk"
    ...
    const val UNSPLASH = "https://unsplash.com${org.sourcei.wallup.deprecated.utils.C.UTM}"
    const val WALLUP_PLAY = "https://play.google.com/store/apps/details?id=com.dawnimpulse.unsplash.wallup"
